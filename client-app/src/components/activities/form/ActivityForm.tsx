...
export const ActivityForm: React.FC<IProps> = ({setEditMode, initialFormActivity, createActivity, editActivity}) => {
    ...
    return (
       <Segment clearing>
           <Form onSubmit={handleSubmit}>
               ...
               <Button floated="right" type="submit" content="Submit" color="instagram"/>
